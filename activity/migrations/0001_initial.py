    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_appointment', models.CharField(blank=True, choices=[('yes', 'Yes'), ('no', 'No')], max_length=20, null=True, verbose_name='Is Appointment')),
                ...
                ('price_included', models.TextField(blank=True, verbose_name='Price Included')),
                ('provider', models.CharField(max_length=100, verbose_name='Provider')),
                ('participants', models.CharField(blank=True, max_length=50, null=True, verbose_name='Participants')),
                ('participating_age', models.CharField(blank=True, max_length=50, null=True, verbose_name='Participating Age')),
                ...
                ('min_p', models.CharField(blank=True, max_length=100, null=True, verbose_name='Min. P')),
                ('reg_deadline', models.CharField(blank=True, max_length=100, null=True, verbose_name='Deadline')),
